...
export type SurveyResponse = {
  ...
  survey?: {
    ...
    _type: "reference";
    _weak?: boolean;
    [internalGroqTypeReferenceTo]?: "survey";
  };
  user?: {
    _ref: string;
    _type: "reference";
...
export type FlaggedContent = {
  ...
  type?: "post" | "comment" | "eventComment" | "marketplaceItem" | "message" | "survey" | "event";
  reason?: string;
  createdAt?: string;
};
...
export type EventComment = {
  ...
  parentComment?: {
    ...
    _type: "reference";
    _weak?: boolean;
    [internalGroqTypeReferenceTo]?: "eventComment";
  };
};
...
export type Event = {
  ...
  title?: string;
  description?: string;
  category?: "academic" | "social" | "sports" | "career" | "cultural" | "technology" | "arts" | "other";
...
export type Appeal = {
  ...
  targetType?: "ban" | "post_removal" | "other";
  targetId?: string;
  reason?: string;
...
export type ModAction = {
  ...
  _updatedAt: string;
  _rev: string;
  actionType?: "ban" | "unban" | "approve_post" | "remove_post" | "assign_mod" | "remove_mod" | "other";
  targetUser?: {
    _ref: string;
    _type: "reference";
    _weak?: boolean;
...
export type Subreddit = {
  ...
  modLogs?: Array<{
    ...
    _weak?: boolean;
    _key: string;
    [internalGroqTypeReferenceTo]?: "modAction";
  }>;
  appeals?: Array<{
    _ref: string;
    _type: "reference";
    _weak?: boolean;
    _key: string;
    [internalGroqTypeReferenceTo]?: "appeal";
  }>;
...
// Query: *[_type == "subreddit" && (slug.current == $slug || title == $title)][0] {      ...,      "slug": slug.current,      "moderator": moderator->{_id, username},      "type": type,      "members": members[]{user, role, status, joinedAt},      "approvalQueue": approvalQueue[]{user, requestedAt},      "modLogs": modLogs[]->,      "appeals": appeals[]->,      "welcomeMessage": welcomeMessage,    }
export type GetSubredditBySlugQueryResult = {
  ...
  modLogs: Array<{
    ...
    _updatedAt: string;
    _rev: string;
    actionType?: "approve_post" | "assign_mod" | "ban" | "other" | "remove_mod" | "remove_post" | "unban";
    targetUser?: {
      _ref: string;
      _type: "reference";
      _weak?: boolean;
  ...
  appeals: Array<{
    ...
    targetType?: "ban" | "other" | "post_removal";
    targetId?: string;
    reason?: string;
  ...
  type: "private" | "public" | "restricted" | null;
} | null;

// Source: ./sanity/lib/subreddit/getSubreddits.ts
// Variable: getSubredditsQuery
// Query: *[_type == "subreddit"] {        ...,        "slug": slug.current,        "moderator": moderator->,        "members": members[]{user, status},      } | order(createdAt desc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"user\" && clerkId == $clerkId][0]": GetExistingUserQueryResult;
